...
switch(doYouLikeReading) {
  ...
  case userAnswerYes:
    ...
    break;
  default:
    console.log("Just use a normal answer you would normally give to a normal person. Otherwise you'll (hopefully) keep seeing this message (if I coded it right).");
}
